                        ...
                        <form action="experiences.php" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="e_description" id="editor1" class="form-control" placeholder="Insérer une description"></textarea>
                                </div>
                                <script>CKEDITOR.replace('editor1');</script><!--on le remplace que dans le textarea -->
