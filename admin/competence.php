...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Architects+Daughter|Bitter|Cardo|Cookie|Parisienne|Tangerine" rel="stylesheet">
    <!-- Bootstrap -->
   ...
   <?php
        ...
        $resultat->execute();
        $nbr_competence = $resultat->rowCount();
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h4 class="well">J'ai <?= $nbr_competence;?> competences<?= ($nbr_competence>1)?'s':''?></h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                             ...
                             <div class="panel-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="c_niveau" id="competence" placeholder="Insérer le niveau"  class="form-control">
                                    </div>
